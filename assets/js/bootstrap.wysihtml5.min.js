!(function (a, b) {
	...
	var c = function (a, b) {
			var c = {
				"font-styles":
					...
					"</li>",
				emphasis:
					"<li><div class='btn-group'><a class='btn' data-wysihtml5-command='bold' title='CTRL+B'>" +
					b.emphasis.bold +
					"</a>" +
					"<a class='btn' data-wysihtml5-command='italic' title='CTRL+I'>" +
					b.emphasis.italic +
					"</a>" +
					"<a class='btn' data-wysihtml5-command='underline' title='CTRL+U'>" +
					b.emphasis.underline +
					"</a>" +
					"</div>" +
					"</li>",
				lists:
					"<li><div class='btn-group'><a class='btn' data-wysihtml5-command='insertUnorderedList' title='" +
					b.lists.unordered +
					"'><i class='icon-list'></i></a>" +
					"<a class='btn' data-wysihtml5-command='insertOrderedList' title='" +
					b.lists.ordered +
					"'><i class='icon-th-list'></i></a>" +
					"<a class='btn' data-wysihtml5-command='Outdent' title='" +
					b.lists.outdent +
					"'><i class='icon-indent-right'></i></a>" +
					"<a class='btn' data-wysihtml5-command='Indent' title='" +
					b.lists.indent +
					"'><i class='icon-indent-left'></i></a>" +
					"</div>" +
					"</li>",
				link:
					"<li><div class='bootstrap-wysihtml5-insert-link-modal modal hide fade'><div class='modal-header'><a class='close' data-dismiss='modal'>&times;</a><h3>" +
					b.link.insert +
					"</h3>" +
					"</div>" +
					...
					"</div>" +
					"</div>" +
					"<a class='btn' data-wysihtml5-command='createLink' title='" +
					b.link.insert +
					"'><i class='icon-share'></i></a>" +
					"</li>",
				image:
					"<li><div class='bootstrap-wysihtml5-insert-image-modal modal hide fade'><div class='modal-header'><a class='close' data-dismiss='modal'>&times;</a><h3>" +
					b.image.insert +
					"</h3>" +
					"</div>" +
					"<div class='modal-body'>" +
					...
					"</div>" +
					"</div>" +
					"<a class='btn' data-wysihtml5-command='insertImage' title='" +
					b.image.insert +
					"'><i class='icon-picture'></i></a>" +
					"</li>",
				html:
					"<li><div class='btn-group'><a class='btn' data-wysihtml5-action='change_view' title='" +
					b.html.edit +
					"'><i class='icon-pencil'></i></a>" +
					"</div>" +
					"</li>",
				color:
					"<li class='dropdown'><a class='btn dropdown-toggle' data-toggle='dropdown' href='#'><span class='current-color'>" +
					b.colours.black +
					"</span>&nbsp;<b class='caret'></b>" +
					"</a>" +
					"<ul class='dropdown-menu'>" +
		...
		d = function (b, c) {
			(this.el = b),
				(this.toolbar = this.createToolbar(b, c || f)),
				(this.editor = this.createEditor(c)),
	...
	d.prototype = {
		...
		createToolbar: function (b, d) {
			var e = this,
				h = a("<ul/>", { class: "wysihtml5-toolbar", style: "display:none" }),
				i = d.locale || f.locale || "en";
			for (var j in f) {
				var k = !1;
				d[j] !== undefined ? d[j] === !0 && (k = !0) : (k = f[j]),
					k === !0 &&
						(h.append(c(j, g[i])),
						j === "html" && this.initHtml(h),
						j === "link" && this.initInsertLink(h),
						j === "image" && this.initInsertImage(h));
			}
			if (d.toolbar) for (j in d.toolbar) h.append(d.toolbar[j]);
			return (
				h.find("a[data-wysihtml5-command='formatBlock']").click(function (b) {
		...
		initInsertLink: function (b) {
			var c = this,
				...
				h = function () {
					var a = e.val();
					e.val(g),
						c.editor.composer.commands.exec("createLink", {
							href: a,
							target: "_blank",
							rel: "nofollow",
						});
	...
	typeof a.fn.wysihtml5.defaultOptionsCache == "undefined" &&
